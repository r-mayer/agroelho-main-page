...
export const Header = () => {
  return (
    <>
      <div className="w-full pt-12 lg:pt-16 pb-8 relative px-4 lg:px-0">
        <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row gap-x-8">
          <div className="w-full flex flex-col justify-center gap-y-1 text-slate-800 z-40">
            <h1 className="text-3xl text-center lg:text-left lg:text-7xl max-w-[620px] font-medium mb-4 lg:mb-8">
            ...
            <div className="flex flex-col lg:flex-row gap-x-8 gap-y-8 items-center">
              <div className="flex flex-col gap-y-2">
                <div className="flex items-center justify-center gap-x-2 max-w-fit">
                  ...
                  <p className="text-sm lg:text-base">(27) 99611-2633</p>
                </div>
                ...
                <div className="flex items-center justify-center gap-x-2 max-w-fit">
                  ...
                  <p className="text-sm lg:text-base">(27) 3325-9042</p>
                </div>
                <div className="flex items-center justify-center gap-x-2 max-w-fit">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_2301_253)">
                  ...
                  <p className="text-sm lg:text-base">(27) 3227-4053</p>
                </div>
              </div>

              <p className="font-semibold text-center text-base mb-4 lg:mb-0">Faça seu pedido pelo WhatsApp</p>
            </div>
          </div>

          <div className="w-full flex">
            <div className="w-full max-w-[500px] lg:max-w-[400px] mx-auto">
      ...
      <div className="w-full py-12 bg-rose-50 px-4 lg:px-0">
        <div className="w-full flex flex-col gap-y-6 lg:flex-row gap-x-20 justify-center max-w-7xl mx-auto">
      ...
      <div className="w-full py-12 lg:py-20 bg-slate-50 px-4 lg:px-0" id="location">
        <div className="w-full flex flex-col lg:flex-row gap-y-8 gap-x-12 max-w-7xl items-center mx-auto">
          ...
          <div className="flex w-full flex-col gap-y-8 lg:max-w-[600px]">
            <div className="w-full items-center gap-x-4 flex">
              <figure className="w-6 h-6 flex items-center justify-center">
                <LocationIcon />
              </figure>
              ...
              <article className="flex flex-col flex-1">
                <p className="font-medium text-base lg:text-xl">Localização</p>
                <p className="text-sm lg:text-base text-slate-500">Av. Maruípe, 1530 - Bonfim, Vitória - ES, 29047-110</p>
              </article>
            </div>
            ...
            <div className="w-full items-center gap-x-4 flex">
              ...
              <article className="flex flex-col flex-1">
                <p className="font-medium lg:text-xl">Funcionamento</p>
                <p className="text-sm lg:text-base text-slate-500">Segunda a Sexta - 8h às 18h</p>
                <p className="text-sm lg:text-base text-slate-500">Sábado - 8h às 12h</p>
              </article>
            </div>
          </div>
        </div>
